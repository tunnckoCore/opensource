...
[npmv-img]: https://badgen.net/npm/v/@tunnckocore/create-jest-runner?icon=npm?cache=1
...
[license-img]: https://badgen.net/npm/license/@tunnckocore/create-jest-runner?cache=1
...
[codecoverage-img]: https://badgen.net/badge/coverage/20.11%25/red?icon=codecov&cache=1
...
[downloads-weekly-img]: https://badgen.net/npm/dw/@tunnckocore/create-jest-runner?icon=npm&cache=1
[downloads-monthly-img]: https://badgen.net/npm/dm/@tunnckocore/create-jest-runner?icon=npm&cache=1
[downloads-total-img]: https://badgen.net/npm/dt/@tunnckocore/create-jest-runner?icon=npm&cache=1
