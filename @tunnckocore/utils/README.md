...
[npmv-img]: https://badgen.net/npm/v/@tunnckocore/utils?icon=npm?cache=1
...
[license-img]: https://badgen.net/npm/license/@tunnckocore/utils?cache=1
...
[downloads-weekly-img]: https://badgen.net/npm/dw/@tunnckocore/utils?icon=npm&cache=1
[downloads-monthly-img]: https://badgen.net/npm/dm/@tunnckocore/utils?icon=npm&cache=1
[downloads-total-img]: https://badgen.net/npm/dt/@tunnckocore/utils?icon=npm&cache=1
