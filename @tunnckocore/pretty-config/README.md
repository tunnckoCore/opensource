...
[npmv-img]: https://badgen.net/npm/v/@tunnckocore/pretty-config?icon=npm?cache=1
...
[license-img]: https://badgen.net/npm/license/@tunnckocore/pretty-config?cache=1
...
[codecoverage-img]: https://badgen.net/badge/coverage/2.08%25/red?icon=codecov&cache=1
...
[downloads-weekly-img]: https://badgen.net/npm/dw/@tunnckocore/pretty-config?icon=npm&cache=1
[downloads-monthly-img]: https://badgen.net/npm/dm/@tunnckocore/pretty-config?icon=npm&cache=1
[downloads-total-img]: https://badgen.net/npm/dt/@tunnckocore/pretty-config?icon=npm&cache=1
