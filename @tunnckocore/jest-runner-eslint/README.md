...
[npmv-img]: https://badgen.net/npm/v/@tunnckocore/jest-runner-eslint?icon=npm?cache=1
...
[license-img]: https://badgen.net/npm/license/@tunnckocore/jest-runner-eslint?cache=1
...
[codecoverage-img]: https://badgen.net/badge/coverage/11.29%25/red?icon=codecov&cache=1
...
[downloads-weekly-img]: https://badgen.net/npm/dw/@tunnckocore/jest-runner-eslint?icon=npm&cache=1
[downloads-monthly-img]: https://badgen.net/npm/dm/@tunnckocore/jest-runner-eslint?icon=npm&cache=1
[downloads-total-img]: https://badgen.net/npm/dt/@tunnckocore/jest-runner-eslint?icon=npm&cache=1
