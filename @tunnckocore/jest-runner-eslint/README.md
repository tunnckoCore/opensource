...
[yarnpkg.com](https://yarnpkg.com/en/package/@tunnckocore/jest-runner-eslint)
sites too! :rocket:
...
[twitter-share-url]: https://twitter.com/intent/tweet?text=https://ghub.now.sh/@tunnckocore/jest-runner-eslint&via=tunnckoCore
