...
export const eslint = 'eslint . --format codeframe'; // ! Not called if `eslint` task fails

export const posteslint = 'echo "Done linting!"'; // Super composable, flexible and crazy, huh?!

export const eslintFix = [`${eslint} --fix --quiet`, posteslint];
export const tryme = 'echo "will override pkg.scripts.tryme"'; // try `npm start buildExample` haha
...
export const postadvanced = ['echo "advanced is done"', basicPrettier]; // ? also try running some not existing command or binary
