# @tunnckocore/jest-runner-babel [![npm version][npmv-img]][npmv-url] [![License][license-img]][license-url]
...
[npmv-img]: https://badgen.net/npm/v/@tunnckocore/jest-runner-babel?icon=npm&cache=123
...
[license-img]: https://badgen.net/npm/license/@tunnckocore/jest-runner-babel?cache=123
...
[codecoverage-img]: https://badgen.net/badge/coverage/8.93%25/red?icon=codecov&cache=123
...
[downloads-weekly-img]: https://badgen.net/npm/dw/@tunnckocore/jest-runner-babel?icon=npm&cache=123
[downloads-monthly-img]: https://badgen.net/npm/dm/@tunnckocore/jest-runner-babel?icon=npm&cache=123
[downloads-total-img]: https://badgen.net/npm/dt/@tunnckocore/jest-runner-babel?icon=npm&cache=123
