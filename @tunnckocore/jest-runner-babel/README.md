# @tunnckocore/jest-runner-babel [![npm version][npmv-img]][npmv-url] [![License][license-img]][license-url] [![Libera Manifesto][libera-manifesto-img]][libera-manifesto-url]

> Fork of the original Jest Runner for Babel and a lot better, plays nicely with
> monorepos
...
[yarnpkg.com](https://yarnpkg.com/en/package/@tunnckocore/jest-runner-babel)
sites too! :rocket:
...
[npmv-img]: https://badgen.net/npm/v/@tunnckocore/jest-runner-babel?icon=npm&cache=300

[license-url]: https://github.com/tunnckoCore/opensource/blob/master/@tunnckocore/jest-runner-babel/LICENSE
[license-img]: https://badgen.net/npm/license/@tunnckocore/jest-runner-babel?cache=300
...
[codecoverage-img]: https://badgen.net/badge/coverage/6.96%25/red?icon=codecov&cache=300 
...
[downloads-weekly-img]: https://badgen.net/npm/dw/@tunnckocore/jest-runner-babel?icon=npm&cache=300
[downloads-monthly-img]: https://badgen.net/npm/dm/@tunnckocore/jest-runner-babel?icon=npm&cache=300
[downloads-total-img]: https://badgen.net/npm/dt/@tunnckocore/jest-runner-babel?icon=npm&cache=300
...
[twitter-share-url]: https://twitter.com/intent/tweet?text=https://ghub.now.sh/@tunnckocore/jest-runner-babel&via=tunnckoCore
