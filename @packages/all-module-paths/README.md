# all-module-paths [![npm version][npmv-img]][npmv-url] [![License][license-img]][license-url] [![Libera Manifesto][libera-manifesto-img]][libera-manifesto-url]

> Get all possible javascript (npm/yarn/pnpm) global or local, binaries or
> packages paths, e.g. node_modules and node_modules/.bin. Also works for those
> using NVM or such
...
[yarnpkg.com](https://yarnpkg.com/en/package/all-module-paths) sites too!
:rocket:
...
[npmv-url]: https://www.npmjs.com/package/all-module-paths
[npmv-img]: https://badgen.net/npm/v/all-module-paths?icon=npm&cache=300

[license-url]: https://github.com/tunnckoCore/opensource/blob/master/packages/all-module-paths/LICENSE
[license-img]: https://badgen.net/npm/license/all-module-paths?cache=300
...
[codecoverage-img]: https://badgen.net/badge/coverage/95.35%25/99CC09?icon=codecov&cache=300 
...
[downloads-weekly-img]: https://badgen.net/npm/dw/all-module-paths?icon=npm&cache=300
[downloads-monthly-img]: https://badgen.net/npm/dm/all-module-paths?icon=npm&cache=300
[downloads-total-img]: https://badgen.net/npm/dt/all-module-paths?icon=npm&cache=300
...
[twitter-share-url]: https://twitter.com/intent/tweet?text=https://ghub.now.sh/all-module-paths&via=tunnckoCore
