...
> Simple command line interface for the `git clone` command, using [gitclone][]
> package
...
[yarnpkg.com](https://yarnpkg.com/en/package/gitclone-cli) sites too! :rocket:
...
[twitter-share-url]: https://twitter.com/intent/tweet?text=https://ghub.now.sh/gitclone-cli&via=tunnckoCore
