# @hela/dev [![npm version][npmv-img]][npmv-url] [![License][license-img]][license-url]
...
[Become a Partner or Sponsor?][patreon-url] :dollar: Check the **Partner**, **Sponsor** or **Omega-level** tiers! :tada: You can get your company logo, link & name on this file. It's also rendered on package page in [npmjs.com][npmv-url] and [yarnpkg.com](https://yarnpkg.com/en/package/@hela/dev) sites too! :rocket:
...
[npmv-url]: https://www.npmjs.com/package/@hela/dev
[npmv-img]: https://badgen.net/npm/v/@hela/dev?icon=npm
...
[license-url]: https://github.com/tunnckoCore/opensource/blob/master/@hela/dev/LICENSE
[license-img]: https://badgen.net/npm/license/@hela/dev
...
[codecoverage-img]: https://badgen.net/badge/coverage/18.33%25/red?icon=codecov
...
[downloads-weekly-img]: https://badgen.net/npm/dw/@hela/dev?icon=npm
[downloads-monthly-img]: https://badgen.net/npm/dm/@hela/dev?icon=npm
[downloads-total-img]: https://badgen.net/npm/dt/@hela/dev?icon=npm
