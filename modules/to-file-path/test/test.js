...
test('should JSON.stringify object values', async () => {
...
test('should create filepath from string with dot notation', async () => {
...
test('should create filepath from list of arguments', async () => {
...
test('should create filepath from mixed type of arguments', async () => {
  const actual = toPath(
    123,
    'foo.bar',
...
test('should create filepath from Arguments object', async () => {
