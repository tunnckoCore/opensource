...
> Return positive value if (any of the) passed value(s) exists in array, or
> optionally an index
...
[yarnpkg.com](https://yarnpkg.com/en/package/arr-includes) sites too! :rocket:
...
[twitter-share-url]: https://twitter.com/intent/tweet?text=https://ghub.now.sh/arr-includes&via=tunnckoCore
