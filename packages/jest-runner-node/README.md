...
[npmv-img]: https://badgen.net/npm/v/jest-runner-node?icon=npm?cache=1
...
[license-img]: https://badgen.net/npm/license/jest-runner-node?cache=1
...
[downloads-weekly-img]: https://badgen.net/npm/dw/jest-runner-node?icon=npm&cache=1
[downloads-monthly-img]: https://badgen.net/npm/dm/jest-runner-node?icon=npm&cache=1
[downloads-total-img]: https://badgen.net/npm/dt/jest-runner-node?icon=npm&cache=1
