...
[npmv-img]: https://badgen.net/npm/v/gitclone-defaults?icon=npm?cache=1
...
[license-img]: https://badgen.net/npm/license/gitclone-defaults?cache=1
...
[downloads-weekly-img]: https://badgen.net/npm/dw/gitclone-defaults?icon=npm&cache=1
[downloads-monthly-img]: https://badgen.net/npm/dm/gitclone-defaults?icon=npm&cache=1
[downloads-total-img]: https://badgen.net/npm/dt/gitclone-defaults?icon=npm&cache=1
