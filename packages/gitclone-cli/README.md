...
[npmv-img]: https://badgen.net/npm/v/gitclone-cli?icon=npm?cache=1
...
[license-img]: https://badgen.net/npm/license/gitclone-cli?cache=1
...
[downloads-weekly-img]: https://badgen.net/npm/dw/gitclone-cli?icon=npm&cache=1
[downloads-monthly-img]: https://badgen.net/npm/dm/gitclone-cli?icon=npm&cache=1
[downloads-total-img]: https://badgen.net/npm/dt/gitclone-cli?icon=npm&cache=1
