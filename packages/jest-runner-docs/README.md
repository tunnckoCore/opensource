...
[Become a Partner or Sponsor?][patreon-url] :dollar: Check the **Partner**, **Sponsor** or **Omega-level** tiers! :tada: You can get your company logo, link & name on this file. It's also rendered on package page in [npmjs.com][npmv-url] and [yarnpkg.com](https://yarnpkg.com/en/package/jest-runner-docs) sites too! :rocket:
...
[npmv-img]: https://badgen.net/npm/v/jest-runner-docs?icon=npm&cache=123
...
[license-img]: https://badgen.net/npm/license/jest-runner-docs?cache=123
...
[codecoverage-img]: https://badgen.net/badge/coverage/6.82%25/red?icon=codecov&cache=123
...
[downloads-weekly-img]: https://badgen.net/npm/dw/jest-runner-docs?icon=npm&cache=123
[downloads-monthly-img]: https://badgen.net/npm/dm/jest-runner-docs?icon=npm&cache=123
[downloads-total-img]: https://badgen.net/npm/dt/jest-runner-docs?icon=npm&cache=123
