...
[npmv-img]: https://badgen.net/npm/v/jest-runner-docs?icon=npm?cache=1
...
[license-img]: https://badgen.net/npm/license/jest-runner-docs?cache=1
...
[codecoverage-img]: https://badgen.net/badge/coverage/6.82%25/red?icon=codecov&cache=1
...
[downloads-weekly-img]: https://badgen.net/npm/dw/jest-runner-docs?icon=npm&cache=1
[downloads-monthly-img]: https://badgen.net/npm/dm/jest-runner-docs?icon=npm&cache=1
[downloads-total-img]: https://badgen.net/npm/dt/jest-runner-docs?icon=npm&cache=1
