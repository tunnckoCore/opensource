...
[npmv-img]: https://badgen.net/npm/v/koa-better-body?icon=npm
...
[codecoverage-img]: https://badgen.net/badge/coverage/95.56%25/99CC09?icon=codecov
...
[downloads-weekly-img]: https://badgen.net/npm/dw/koa-better-body?icon=npm
