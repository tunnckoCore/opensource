...
[npmv-img]: https://badgen.net/npm/v/koa-better-body?icon=npm?cache=1
...
[license-img]: https://badgen.net/npm/license/koa-better-body?cache=1
...
[codecoverage-img]: https://badgen.net/badge/coverage/95.56%25/99CC09?icon=codecov&cache=1
...
[downloads-weekly-img]: https://badgen.net/npm/dw/koa-better-body?icon=npm&cache=1
[downloads-monthly-img]: https://badgen.net/npm/dm/koa-better-body?icon=npm&cache=1
[downloads-total-img]: https://badgen.net/npm/dt/koa-better-body?icon=npm&cache=1
