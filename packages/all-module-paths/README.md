...
[npmv-img]: https://badgen.net/npm/v/all-module-paths?icon=npm?cache=1
...
[license-img]: https://badgen.net/npm/license/all-module-paths?cache=1
...
[codecoverage-img]: https://badgen.net/badge/coverage/95.35%25/99CC09?icon=codecov&cache=1
...
[downloads-weekly-img]: https://badgen.net/npm/dw/all-module-paths?icon=npm&cache=1
[downloads-monthly-img]: https://badgen.net/npm/dm/all-module-paths?icon=npm&cache=1
[downloads-total-img]: https://badgen.net/npm/dt/all-module-paths?icon=npm&cache=1
