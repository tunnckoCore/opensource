...
[npmv-img]: https://badgen.net/npm/v/arr-includes?icon=npm?cache=1
...
[license-img]: https://badgen.net/npm/license/arr-includes?cache=1
...
[downloads-weekly-img]: https://badgen.net/npm/dw/arr-includes?icon=npm&cache=1
[downloads-monthly-img]: https://badgen.net/npm/dm/arr-includes?icon=npm&cache=1
[downloads-total-img]: https://badgen.net/npm/dt/arr-includes?icon=npm&cache=1
