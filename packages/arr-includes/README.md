# arr-includes [![npm version][npmv-img]][npmv-url] [![License][license-img]][license-url] [![Libera Manifesto][libera-manifesto-img]][libera-manifesto-url]
...
[npmv-img]: https://badgen.net/npm/v/arr-includes?icon=npm&cache=300
[license-url]: https://github.com/tunnckoCore/opensource/blob/master/packages/arr-includes/LICENSE
[license-img]: https://badgen.net/npm/license/arr-includes?cache=300
...
[downloads-weekly-img]: https://badgen.net/npm/dw/arr-includes?icon=npm&cache=300
[downloads-monthly-img]: https://badgen.net/npm/dm/arr-includes?icon=npm&cache=300
[downloads-total-img]: https://badgen.net/npm/dt/arr-includes?icon=npm&cache=300
