...
[npmv-img]: https://badgen.net/npm/v/@tunnckocore/browserslist-config?icon=npm?cache=1
...
[license-img]: https://badgen.net/npm/license/@tunnckocore/browserslist-config?cache=1
...
[downloads-weekly-img]: https://badgen.net/npm/dw/@tunnckocore/browserslist-config?icon=npm&cache=1
[downloads-monthly-img]: https://badgen.net/npm/dm/@tunnckocore/browserslist-config?icon=npm&cache=1
[downloads-total-img]: https://badgen.net/npm/dt/@tunnckocore/browserslist-config?icon=npm&cache=1
