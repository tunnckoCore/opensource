...
[npmv-img]: https://badgen.net/npm/v/@tunnckocore/renovate-config?icon=npm?cache=1
...
[license-img]: https://badgen.net/npm/license/@tunnckocore/renovate-config?cache=1
...
[downloads-weekly-img]: https://badgen.net/npm/dw/@tunnckocore/renovate-config?icon=npm&cache=1
[downloads-monthly-img]: https://badgen.net/npm/dm/@tunnckocore/renovate-config?icon=npm&cache=1
[downloads-total-img]: https://badgen.net/npm/dt/@tunnckocore/renovate-config?icon=npm&cache=1
