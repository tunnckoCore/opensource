# @tunnckocore/renovate-config [![npm version][npmv-img]][npmv-url] [![License][license-img]][license-url]
...
[npmv-img]: https://badgen.net/npm/v/@tunnckocore/renovate-config?icon=npm&cache=123
...
[license-img]: https://badgen.net/npm/license/@tunnckocore/renovate-config?cache=123
...
[downloads-weekly-img]: https://badgen.net/npm/dw/@tunnckocore/renovate-config?icon=npm&cache=123
[downloads-monthly-img]: https://badgen.net/npm/dm/@tunnckocore/renovate-config?icon=npm&cache=123
[downloads-total-img]: https://badgen.net/npm/dt/@tunnckocore/renovate-config?icon=npm&cache=123
