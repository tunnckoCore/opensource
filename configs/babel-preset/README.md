...
[npmv-img]: https://badgen.net/npm/v/@tunnckocore/babel-preset?icon=npm?cache=1
...
[license-img]: https://badgen.net/npm/license/@tunnckocore/babel-preset?cache=1
...
[codecoverage-img]: https://badgen.net/badge/coverage/74.92%25/EEAA22?icon=codecov&cache=1
...
[downloads-weekly-img]: https://badgen.net/npm/dw/@tunnckocore/babel-preset?icon=npm&cache=1
[downloads-monthly-img]: https://badgen.net/npm/dm/@tunnckocore/babel-preset?icon=npm&cache=1
[downloads-total-img]: https://badgen.net/npm/dt/@tunnckocore/babel-preset?icon=npm&cache=1
