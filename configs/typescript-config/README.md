...
[npmv-img]: https://badgen.net/npm/v/@tunnckocore/typescript-config?icon=npm&cache=123
...
[license-img]: https://badgen.net/npm/license/@tunnckocore/typescript-config?cache=123
...
[downloads-weekly-img]: https://badgen.net/npm/dw/@tunnckocore/typescript-config?icon=npm&cache=123
[downloads-monthly-img]: https://badgen.net/npm/dm/@tunnckocore/typescript-config?icon=npm&cache=123
[downloads-total-img]: https://badgen.net/npm/dt/@tunnckocore/typescript-config?icon=npm&cache=123
