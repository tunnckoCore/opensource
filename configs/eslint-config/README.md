...
[npmv-img]: https://badgen.net/npm/v/@tunnckocore/eslint-config?icon=npm&cache=123
...
[license-img]: https://badgen.net/npm/license/@tunnckocore/eslint-config?cache=123
...
[downloads-weekly-img]: https://badgen.net/npm/dw/@tunnckocore/eslint-config?icon=npm&cache=123
[downloads-monthly-img]: https://badgen.net/npm/dm/@tunnckocore/eslint-config?icon=npm&cache=123
[downloads-total-img]: https://badgen.net/npm/dt/@tunnckocore/eslint-config?icon=npm&cache=123
