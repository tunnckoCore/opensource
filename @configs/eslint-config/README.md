...
[yarnpkg.com](https://yarnpkg.com/en/package/@tunnckocore/eslint-config) sites
too! :rocket:
...
[twitter-share-url]: https://twitter.com/intent/tweet?text=https://ghub.now.sh/@tunnckocore/eslint-config&via=tunnckoCore
