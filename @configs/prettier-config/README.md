# @tunnckocore/prettier-config [![npm version][npmv-img]][npmv-url] [![License][license-img]][license-url] [![Libera Manifesto][libera-manifesto-img]][libera-manifesto-url]
...
[yarnpkg.com](https://yarnpkg.com/en/package/@tunnckocore/prettier-config) sites
too! :rocket:
...
[npmv-img]: https://badgen.net/npm/v/@tunnckocore/prettier-config?icon=npm&cache=300

[license-url]: https://github.com/tunnckoCore/opensource/blob/master/@tunnckocore/prettier-config/LICENSE
[license-img]: https://badgen.net/npm/license/@tunnckocore/prettier-config?cache=300
...
[downloads-weekly-img]: https://badgen.net/npm/dw/@tunnckocore/prettier-config?icon=npm&cache=300
[downloads-monthly-img]: https://badgen.net/npm/dm/@tunnckocore/prettier-config?icon=npm&cache=300
[downloads-total-img]: https://badgen.net/npm/dt/@tunnckocore/prettier-config?icon=npm&cache=300
...
[twitter-share-url]: https://twitter.com/intent/tweet?text=https://ghub.now.sh/@tunnckocore/prettier-config&via=tunnckoCore
