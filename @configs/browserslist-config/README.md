# @tunnckocore/browserslist-config [![npm version][npmv-img]][npmv-url] [![License][license-img]][license-url] [![Libera Manifesto][libera-manifesto-img]][libera-manifesto-url]
...
[yarnpkg.com](https://yarnpkg.com/en/package/@tunnckocore/browserslist-config)
sites too! :rocket:
...
[twitter-share-url]: https://twitter.com/intent/tweet?text=https://ghub.now.sh/@tunnckocore/browserslist-config&via=tunnckoCore
