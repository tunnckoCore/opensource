...
[npmv-img]: https://badgen.net/npm/v/{%= name %}?icon=npm&cache=123
[nodejs-img]: https://badgen.net/badge/node/{%= engines.node %}/green?cache=123
...
[license-img]: https://badgen.net/npm/license/{%= name %}?cache=123
...
{% } else { %}
[codecoverage-img]: https://badgen.net/badge/coverage/{%= cov.value %}%25/{%= cov.color %}?icon=codecov&cache=123
{% } %}
...
[downloads-weekly-img]: https://badgen.net/npm/dw/{%= name %}?icon=npm&cache=123
[downloads-monthly-img]: https://badgen.net/npm/dm/{%= name %}?icon=npm&cache=123
[downloads-total-img]: https://badgen.net/npm/dt/{%= name %}?icon=npm&cache=123
